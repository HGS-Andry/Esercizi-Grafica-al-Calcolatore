...
void initialize_texture()
{
	...
	// shaderProgram must be already initialized
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_S, GL_REPEAT);  //Prima era GL_CLAPM_TO_EDGE   solo per ripetizione sull'asse X!!
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_REPEAT);  //Prima era GL_CLAPM_TO_EDGE   solo per ripetizione sull'asse Y!!
